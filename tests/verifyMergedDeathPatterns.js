const { DeathCause } = require("../dist/database/models/DeathModel");
const { defaultDeathPatterns } = require("../dist/utils/analytics/defaultDeathPatterns");
const { DeathParserService } = require("../dist/services/analytics/DeathParserService");
