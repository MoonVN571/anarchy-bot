module.exports = {
    ...
    stats: {
        ...
        killBefore: /^([^ ]*) (?:killed) ([^ ]*)(.*)$/,
        killAfter: /^([^ ]*) (?:was squished by a|đã được|was pushed into the void by|was pushed into lava by|tried playing with|stood too close to|was spat on by a|was ganed up on by some|tried climbing to greater heights and fell off|was ganged up on by some|was pushed off a high place by|was shot by|was blown up by a|was slain by) ([^ ]*)(.*)$/,
